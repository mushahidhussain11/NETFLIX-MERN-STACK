    ...
    <div className='bg-black min-h-screen text-white'>
        <div className='mx-auto container px-4 py-8 h-full'>
          ...
          <div className='aspect-video mb-8 p-2 sm:px-10 md:px-32'>
              ...
              {trailers.length===0 && (
                <h2 className='text-xl text-center mt-5'>No trailers availble for {" "}
            ...
            <div className='mt-12 max-w-5xl mx-auto relative'>
                ...
                <div className='flex overflow-x-scroll scrollbar-hide gap-4 pb-4 group' ref={sliderRef}>
                  ...
                  {similarContent.map((content)=>(
                      <Link key={content.id} to={`/watch/${content.id}`} className='w-32 flex-none'>
                ...
                <ChevronRight
								className='absolute mt-24 -translate-y-1/2 right-2 w-8 h-8
										opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer
										 bg-red-600 text-white rounded-full'
								onClick={scrollRight}
							  />
							  <ChevronLeft
								className='absolute mt-24 -translate-y-1/2 left-2 w-8 h-8 opacity-0 
